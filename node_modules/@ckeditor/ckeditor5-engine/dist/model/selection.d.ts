...
declare const ModelSelectionBase: EmitterMixinConstructor<typeof ModelTypeCheckable>;
/**
...
*/
export declare class ModelSelection extends ModelSelectionBase {
	/**
	...
	* @internal
	*/
	constructor(...args: [] | [selectable: ModelNode, placeOrOffset: ModelPlaceOrOffset, options?: {
		backward?: boolean;
	}] | [selectable?: Exclude<ModelSelectable, ModelNode>, options?: {
		backward?: boolean;
	}]);
	/**
	...
	* ```
	*/
	setTo(...args: [selectable: ModelNode, placeOrOffset: ModelPlaceOrOffset, options?: {
		backward?: boolean;
	}] | [selectable?: Exclude<ModelSelectable, ModelNode>, options?: {
		backward?: boolean;
	}]): void;
