...
VALUES (1, 'user-uuid-1111-2222-333333333333', 'admin', 'admin@sinjaikab.go.id', '$2y$10$wE99Y0gN9KpeA4uQ.t4XqOqGf.uWlD2k3eI9fP2L581r9/r0s2UjG', 'Admin DPK', 1, NOW());
...
(6, 'art-uuid-6', 'Cara Mudah Mendaftar Keanggotaan Perpustakaan Daerah', 'cara-mudah-mendaftar-keanggotaan-perpustakaan-daerah', 'Masyarakat kini bisa mendaftar keanggotaan perpustakaan secara online melalui aplikasi atau web resmi DPK.', 'https://lh3.googleusercontent.com/aida-public/AB6AXuCxgyemN4iKt782HpTchol2fqbhHvA-JMvyCltrLReh1IiUaOlO0f72tPzB2Oj1tOcrexQhvy3XqqTnGN-eSta4mArYsTXpeph5DGrd-moMSxVk0tTgC79xAT37Ie00aMd4jQilA4VWbLE1UWdj14hTzDbIJW0QWoFW8aNFucPNxcc2EchLtcMZuRT_ISAdlXtISdBBGM4-QrLeU7_W6V6mOzMEWojG2jnGKRWr3dNXFzAeDkoGiD7p6Q', 'Masyarakat kini bisa mendaftar keanggotaan perpustakaan secara online.', 1, 'Ditayangkan', 982, '2026-07-07 15:00:00'),
(7, 'art-uuid-7', 'Draft Rapat Koordinasi Tahunan', 'draft-rapat-koordinasi-tahunan', 'Konten draf rapat koordinasi tahunan DPK.', NULL, 'Konten draf rapat koordinasi tahunan DPK.', 1, 'Draf', 0, '2026-07-09 10:00:00');
...
(2, 4, 'Admin DPK', 'admin@sinjaikab.go.id', 'Terima kasih Pak Budi dukungannya.', 'Disetujui', 1, '2026-07-08 09:30:00');,
